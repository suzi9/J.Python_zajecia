...
class Menu(tk.Frame):
    def __init__(self, master):
        ...
        tk.Label(self, text="Wybierz jaką akcje chcesz wykonać:", font="Times 20",
...
class Wyswietlanie(tk.Frame):
    def __init__(self, master):
        ...
        tk.Label(self, text="LISTA WSZYSTKICH KSIĄŻEK W BAZIE", font="Times 20 bold", 
               width= 50, height= 0).pack()
        ...
        #Przyciski
        tk.Button(self, bg="#D3D3D3",text = "Powrót do strony głównej", height=3, 
                width=40, font = "Times 15 bold" , cursor="hand2", 
...
class Dodawanie(tk.Frame):
    def __init__(self,master):
        ...
        tk.Label(self, text="Podaj identyfikator książki",font="Times 13").pack()
        ...
        tk.Button(self,bg="#D3D3D3", text="Zapisz", fg="#3da063",cursor="hand2", width=20,
        ...
        tk.Button(self,bg="#D3D3D3", text="Wyczyść",fg="#4700ff",cursor="hand2" , 
        ...
        tk.Button(self,bg="#D3D3D3", text = "Powrót do strony głównej", height=4, 
                width=40, font = "Times 15 bold" , cursor="hand2", 
                command= lambda: master.zmiana_okna(Menu)).pack()
...
class Usuwanie(tk.Frame):
    def __init__(self, master):
        ...
        tk.Button(self, bg="#D3D3D3",text="Wyświetl bazę po usunięciu książki", cursor="hand2", 
                width=40, height=3 ,font= "Times 15 bold",
                command= lambda: master.zmiana_okna(Wyswietlanie)).pack()
